...
//  --- Implementierung Leseoperationen ------------------------------
  ...
  /** Pr�fen, ob Daten verf�gbar sind. <br />
   *  <br />
   *  Liefert die Anzahl der Bytes, die vom Socket gelesen werden k�nnen,
   *  ohne beim n�chsten Aufruf von read() zu blockieren.<br />
   *  <br />
   *  @return Anzahl der verf�gbaren Bytes
   *  @throws IOException
   */
